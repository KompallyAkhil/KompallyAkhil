...
|---------|-------------|-------|
| [**NexScreen**](https://github.com/KompallyAkhil/NexScreen) | AI resume screening pipeline with multi-agent LangGraph orchestration & SBERT cosine similarity | NextJS · FastAPI · LangGraph · SBERT · Gemini · Docker |
| [**CodeSync**](https://github.com/KompallyAkhil/CodeSync) | Chrome extension that automatically syncs coding solutions from LeetCode, GfG, Codeforces, and HackerRank to GitHub | Chrome-extension · Next.js · Manifest V3 |
